            ...
            <div class="center box">
                ...
                <div class="content">
                    <div class="place">
                        ...
                        <span class="text">Dihatimu</span>
                    </div>
                    <div class="phone">
                        <span class="fas fa-phone-alt"></span>
                        <span class="text">+6285877713117</span>
                    </div>
                    <div class="email">
                        <span class="fas fa-envelope"></span>
                        <span class="text">ptri9030@gmail.com</span>
                    </div>
                </div>
            </div>
            <div class="right box">
                ...
                <div class="content">
                    <form method="post" action="contact">
                        ...
                        <div class="msg">
                            ...
                            <textarea rows="2" cols="25" class="textarea" required name="isi"></textarea>
                        </div>
                        <div class="btnn">
